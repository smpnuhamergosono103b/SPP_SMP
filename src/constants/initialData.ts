...
export const INITIAL_PAYMENT_TYPES: PaymentType[] = [
  ...
  {
    id: 'pt-gedung',
    name: 'Uang Pangkal / Gedung',
    description: 'Pengembangan Sarana dan Prasarana Bangunan Sekolah',
    amount: 1200000,
  ...
  },
  {
    ...
    description: 'Paket Seragam Batik NU, Olahraga, Pramuka & Atribut',
    amount: 450000,
    payment_period: 'one_time',
    is_mandatory: true,
    academic_year_id: 'ay-2025-2026',
  ...
  {
    id: 'pt-ujian',
    name: 'Ujian Semester & Asesmen',
    description: 'Biaya Cetak Lembar Ujian & Administrasi PTS/PAS',
    amount: 100000,
  ...
  {
    id: 'pt-ekstra',
    name: 'Kegiatan Ekstrakurikuler & Pramuka',
    description: 'Iuran Kegiatan Tahunan Pramuka, IPNU/IPPNU, & Olahraga',
    amount: 75000,
    payment_period: 'annual',
    is_mandatory: false,
    academic_year_id: 'ay-2025-2026',
...
export const INITIAL_PAYMENTS: Payment[] = [
  ...
  },
  {
    ...
    nis: '250102',
    class_name: '7-A',
    payment_type_id: 'pt-gedung',
    payment_type_name: 'Uang Pangkal / Gedung',
    academic_year_id: 'ay-2025-2026',
    academic_year_name: '2025/2026',
    month_for: null,
    amount_due: 1200000,
    ...
    receiver_user_id: 'usr-1',
    receiver_name: 'Siti Rahmah, S.Pd.',
    notes: 'Angsuran 1 Uang Gedung (Sisa Rp 600.000)',
  ...
  },
  {
    ...
    nis: '230301',
    class_name: '9-A',
    payment_type_id: 'pt-seragam',
    payment_type_name: 'Uang Seragam & Atribut',
    academic_year_id: 'ay-2025-2026',
    academic_year_name: '2025/2026',
    month_for: null,
    amount_due: 450000,
    ...
    receiver_user_id: 'usr-1',
    receiver_name: 'Siti Rahmah, S.Pd.',
    notes: 'Lunas Ambil Paket Seragam Batik & Olahraga',
